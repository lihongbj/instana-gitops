...
```sh
curl -sSL https://raw.githubusercontent.com/lihongbj/instana-gitops/ocp_n_k8s/config/instana-operator/scripts/prepare.sh | sh
```
...
![app-source](images/app-source.png)


![helm-para](images/helm-para.png)
...
In login UI,
![instana-login](images/instana-login.png)
